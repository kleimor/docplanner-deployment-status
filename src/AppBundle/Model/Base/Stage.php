...
abstract class Stage implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\AppBundle\\Model\\Map\\StageTableMap';
    ...
    /**
     * The value for the tracked_branch field.
     *
     * @var        string
     */
    ...
    /**
     * Initializes internal state of AppBundle\Model\Base\Stage object.
     */
     ...
     *
     * @return $this|Stage The current object, for fluid interface
     */
    ...
    /**
     * Get the [tracked_branch] column value.
     *
     * @return string
     */
    public function getTrackedBranch()
    {
        return $this->tracked_branch;
    }
    ...
    public function setProjectId($v)
    {
        ...
        if ($this->project_id !== $v) {
            $this->project_id = $v;
            $this->modifiedColumns[StageTableMap::COL_PROJECT_ID] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[StageTableMap::COL_TITLE] = true;
        }
    ...
    /**
     * Set the value of [tracked_branch] column.
     *
     * @param string $v new value
     * @return $this|\AppBundle\Model\Stage The current object (for fluent API support)
     */
    public function setTrackedBranch($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->tracked_branch !== $v) {
            $this->tracked_branch = $v;
            $this->modifiedColumns[StageTableMap::COL_TRACKED_BRANCH] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : StageTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : StageTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : StageTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 7; // 7 = StageTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(StageTableMap::COL_TITLE)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\AppBundle\Model\Stage
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\AppBundle\Model\Stage The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StageTableMap::COL_TITLE)) {
            $criteria->add(StageTableMap::COL_TITLE, $this->title);
        }
        if ($this->isColumnModified(StageTableMap::COL_NAME)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AppBundle\Model\Stage (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AppBundle\Model\Stage Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if (null !== $this->aProject) {
            $this->aProject->removeStage($this);
        }
        $this->id = null;
